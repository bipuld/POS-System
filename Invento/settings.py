...
SECRET_KEY = 'django-insecure-glsp%jn+)3d6n_wo(x0an-%e(hk0r0m+r6**joeyn9)3htqxfa'
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Use a dedicated directory for collected files
STATICFILES_DIRS = [
    BASE_DIR / 'invento/static',  # Example app-specific static directory
